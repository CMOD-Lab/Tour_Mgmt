...
/// <summary>
/// Represents a tour package in the Tour Booking system.
/// </summary>
public class Tour
{
    ...
    /// <summary>Gets or sets the tour place/destination.</summary>
    ...
    /// <summary>Gets or sets the bookings for this tour.</summary>
