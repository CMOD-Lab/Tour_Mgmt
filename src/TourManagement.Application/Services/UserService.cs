...
public class UserService : IUserService
{
    ...
    /// <inheritdoc/>
    public async Task<bool> CreateAsync(UserCreateDto dto, CancellationToken cancellationToken = default)
    {
        try
        {
    ...
    /// <inheritdoc/>
    public async Task<bool> UpdateAsync(string email, UserUpdateDto dto, CancellationToken cancellationToken = default)
    {
        try
        {
