...
public class TourServiceTests
{
    ...
    public async Task GetAllToursAsync_ShouldReturnAllTours()
    {
        ...
        {
            new() { TourId = 1, TourName = "Goa Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", TourInfo = "Beach tour", IsActive = true },
            new() { TourId = 2, TourName = "Kashmir Tour", Place = "Kashmir", Days = 7, Price = 25000, Locations = "Kashmir", TourInfo = "Mountain tour", IsActive = true }
        };
    ...
    {
        // Arrange
        var tour = new Tour { TourName = "Kerala Tour", Place = "Kerala", Days = 6, Price = 20000, Locations = "Kerala", TourInfo = "Backwater tour" };
    ...
    public async Task SearchToursAsync_ShouldReturnMatchingTours()
    {
        ...
        var tours = new List<Tour>
        {
            new() { TourId = 1, TourName = "Goa Beach Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", TourInfo = "Beach tour", IsActive = true }
        };
