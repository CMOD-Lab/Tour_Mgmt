...
public class TourRepositoryTests : IDisposable
{
    ...
    {
        // Arrange
        var tour = new Tour { TourName = "Find Tour", Place = "Place", Days = 3, Price = 5000, Locations = "L", TourInfo = "Info", IsActive = true };
        ...
        // Assert
        result.Should().NotBeNull();
        result!.TourName.Should().Be("Find Tour");
    }
    ...
    {
        // Arrange
        var tour = new Tour { TourName = "Delete Tour", Place = "Place", Days = 3, Price = 5000, Locations = "L", TourInfo = "Info", IsActive = true };
        _context.Tours.Add(tour);
        await _context.SaveChangesAsync();
