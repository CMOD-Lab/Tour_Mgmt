...
public class TourServiceTests
{
    ...
    public async Task GetAllAsync_ShouldReturnAllTours()
    {
        ...
        {
            new() { Id = 1, TourName = "Paris Tour", Place = "Paris", Days = 5, Price = 1500, Locations = "Eiffel Tower", TourInfo = "Amazing Paris tour", IsActive = true },
            new() { Id = 2, TourName = "Rome Tour", Place = "Rome", Days = 7, Price = 2000, Locations = "Colosseum", TourInfo = "Historic Rome tour", IsActive = true }
        };
        ...
        result.First().TourName.Should().Be("Paris Tour");
    }
    ...
    {
        // Arrange
        var tour = new Tour { Id = 1, TourName = "Paris Tour", Place = "Paris", Days = 5, Price = 1500, Locations = "Eiffel Tower", TourInfo = "Amazing Paris tour", IsActive = true };
        ...
        result!.TourName.Should().Be("Paris Tour");
    }
    ...
    public async Task SearchAsync_ShouldReturnMatchingTours()
    {
        ...
        result.First().Place.Should().Be("Paris");
    }
}
