...
public class TourServiceTests
{
    ...
    public async Task GetAllAsync_ShouldReturnAllTours()
    {
        ...
        {
            new Tour { Id = 1, TourName = "Goa Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", TourInfo = "Beach tour", IsActive = true, CreatedBy = "system" },
            new Tour { Id = 2, TourName = "Kashmir Tour", Place = "Kashmir", Days = 7, Price = 25000, Locations = "Kashmir", TourInfo = "Mountain tour", IsActive = true, CreatedBy = "system" }
        };
    ...
    {
        // Arrange
        var tour = new Tour { Id = 1, TourName = "Goa Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", TourInfo = "Beach tour", IsActive = true, CreatedBy = "system" };
    ...
    public async Task CreateAsync_WithValidData_ShouldCreateTour()
    {
        ...
        var createdTour = new Tour { Id = 1, TourName = "New Tour", Place = "Mumbai", Days = 3, Price = 10000, Locations = "Mumbai", TourInfo = "City tour", IsActive = true, CreatedBy = "system" };
