...
public class TourServiceTests
{
    ...
    public async Task GetAllAsync_ShouldReturnAllTours()
    {
        ...
        {
            new Tour { TourId = 1, TourName = "Goa Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", IsActive = true },
            new Tour { TourId = 2, TourName = "Kashmir Tour", Place = "Kashmir", Days = 7, Price = 25000, Locations = "Kashmir", IsActive = true }
        };
    ...
    {
        // Arrange
        var tour = new Tour { TourId = 1, TourName = "Goa Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", IsActive = true };
    ...
    public async Task CreateAsync_WithValidData_ShouldCreateTour()
    {
        ...
        var createDto = new TourCreateDto
        {
            ...
            TourInfo = "Beautiful backwaters tour"
        };
    ...
    public async Task SearchAsync_ShouldReturnMatchingTours()
    {
        ...
        var tours = new List<Tour>
        {
            new Tour { TourId = 1, TourName = "Goa Beach Tour", Place = "Goa", Days = 5, Price = 15000, Locations = "Goa", IsActive = true }
        };
